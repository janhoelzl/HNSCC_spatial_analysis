...
def gather_all_metrics(sample_list, joined_samples, QC_im_dir='abc', qsub_im_dir='abc', metrics_list='abc'):
    ...
    for sample in sample_list:
        ...
        #Save tumor circle overlap information
        ...
        red_sample_data.to_csv(f'path_of_choice/Phenotype_data_augmented_{sample}.csv')
        ...
        all_data.to_csv(f'path_of_choice/Intermediary_data_{sample}.csv')
